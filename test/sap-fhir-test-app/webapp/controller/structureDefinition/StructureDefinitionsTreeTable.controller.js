sap.ui.define(["sap/ui/core/mvc/Controller","sap-fhir-test-app/utils/Utils"], function(Controller, Utils) {
	"use strict";

	return Controller.extend("sap-fhir-test-app.controller.structureDefinition.StructureDefinitionsTreeTable", {
