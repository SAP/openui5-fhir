sap.ui.define([
	...
	return Controller.extend("sap-fhir-ui5-model-demo.controller.patient.PatientDetails", {
		...
		_getMessagePopover : function () {
			if (!this._oMessagePopover) {
				this._oMessagePopover = sap.ui.xmlfragment(this.getView().getId(), "sap-fhir-ui5-model-demo.view.patient.fragments.MessagePopover", this);
		...
		onVersicherungMenuAction : function(oEvent) {
			...
			switch (oSelectedItem.getKey()) {
				case "Versicherung":
					this.openInsuranceDialog("dialogAddInsurance", "sap-fhir-ui5-model-demo.view.patient.fragments.PatientDetailsVersicherungDialog");
					break;
				case "Selbstzahler":
		...
		handleValueHelp : function(oEvent, oBinding, sI18nDialogTitle, sFilterParam) {
			...
			this._valueHelpDialog = sap.ui.xmlfragment("sap-fhir-ui5-model-demo.view.patient.fragments.Dialog", this);
