sap.ui.require([
	...
	var sHash = "patients";
	var sViewName = "sap-fhir-ui5-model-demo.view.patient.PatientTable";
	var sViewNameDetails = "sap-fhir-ui5-model-demo.view.patient.PatientDetails";
	var sSearchInputBd = "dpBirthDate";
	var sSearchInputName = "inPatientName";
	var sSearchInputGiven = "inPatientGivenName";
	var sSearchButton = "demoComponent---patientTable--search-btnGo";
	...
	var sTable = "idSmartTable-header";
	//var sPersonalisation = "demoComponent---patientTable--idSmartTable-btnPersonalisation";
	...
	//p13n doesnt trigger rebindtable event has to be checked
	// opaTest("Search via p13ndialog", function(Given,When,Then){
	// 	Given.iStartMyApp(sHash);
	// 	When.iPressButton(sViewName, sPersonalisation);
	// 	When.iPressFilterInP13nDialog();
	// 	var fnSetDateInP13nDialog = function(oP13nDialog){
	// 		var oBdInput = Utils.getControlByParentAndCssClassWithIndex(oP13nDialog[0].getPanels()[2], "sapMInputBase", 1);
	// 		oBdInput.setValue(Utils.formatDate("Jan 24, 1982"));
	// 	};
	// 	When.iDoActionInP13nDialog(fnSetDateInP13nDialog);
	// 	When.iPressOkInP13nDialog();
	// 	Then.theTableSizeShouldBe(1, sViewName, sTable);
	// 	Then.theLabelShouldAppear("Notsowell", sViewName);
	// });
