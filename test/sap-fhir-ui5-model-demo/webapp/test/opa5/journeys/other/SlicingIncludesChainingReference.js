sap.ui.require(["sap/ui/test/Opa5", "sap/ui/test/opaQunit"], function(Opa5, opaTest) {
	...
	var sHash = "";
	var sView = "sap-fhir-ui5-model-demo.view.Home";
	var sViewName = "sap-fhir-ui5-model-demo.view.structureDefinition.StructureDefinitionsListAndTables";
	var sViewInclude = "sap-fhir-ui5-model-demo.view.structureDefinition.IncludeExample";
