sap.ui.define(["../utils/TestUtils", "sap/fhir/model/r4/FHIRUtils"], function(TestUtils, FHIRUtils) {
	...
	QUnit.test("Test function generateFullUrl ", function(assert){
		var sFullUrl = FHIRUtils.generateFullUrl("uuid", "/Patient/123","123","http://example.com");
		...
		sFullUrl = FHIRUtils.generateFullUrl("uuid", "/Patient/f1db03d0-9414-49ea-8554-cdbdede32c98","f1db03d0-9414-49ea-8554-cdbdede32c98","http://example.com");
		...
		sFullUrl = FHIRUtils.generateFullUrl("abc", "/Patient/123","123","http://example.com");
		assert.strictEqual(sFullUrl,"/Patient/123");
		sFullUrl = FHIRUtils.generateFullUrl("oid", "/Patient/123","123","http://example.com");
		assert.strictEqual(sFullUrl,"/Patient/123");
		sFullUrl = FHIRUtils.generateFullUrl("absolute", "/Patient/123","123","http://example.com");
		assert.strictEqual(sFullUrl,"http://example.com/Patient/123");
	});

	QUnit.test("Test function resourceIdIsOfTypeUUID ", function(assert){
		assert.strictEqual(true,FHIRUtils.resourceIdIsOfTypeUUID("f1db03d0-9414-49ea-8554-cdbdede32c98"));
		assert.strictEqual(false,FHIRUtils.resourceIdIsOfTypeUUID("12344556"));
	});
});