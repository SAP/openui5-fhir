...
function replacePlaceholder(sData){
  return sData.replace(/\$\{view.package_version\}/g, this.package_version);
}
...
function buildNav(members) {
  ...
  nav.push(buildNavLink('sample', '<a href="' + env.opts.sample + '" target="_blank">Sample App</a>'))
...
exports.publish = function(taffyData, opts, tutorials) {
  ...
  view = new template.Template(path.join(templatePath, "template"))

  // add some functions to the view
  view.replacePlaceholder = replacePlaceholder;
  ...
  // add package version to view
  view.package_version = process.env.npm_config_releaseVersion || process.env.npm_package_version
