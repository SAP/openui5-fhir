...
var patternReplacer = require("./patternReplacer");
...
function generate(type, title, docs, filename, resolveLinks) {
  ...
  html = patternReplacer(html, package_version);
...
exports.publish = function(taffyData, opts, tutorials) {
  ...
  // add package version to global
  package_version = process.env.npm_config_packageVersion || process.env.npm_package_version
