...
const {PatternReplacer, PatternReplacement} = require("./patternReplacer");
...
const patternReplacer = new PatternReplacer();
...
function generate(type, title, docs, filename, resolveLinks) {
  ...
  html = patternReplacer.replaceAll(html);
...
exports.publish = function(taffyData, opts, tutorials) {
  ...
  patternReplacer.add(new PatternReplacement(/\$\{version\}/g, process.env.npm_config_packageVersion || process.env.npm_package_version));
